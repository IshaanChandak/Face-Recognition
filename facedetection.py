...
download_path = "shape_predictor_68_face_landmarks.dat.bz2"
...
# Delete the downloaded file if desired
# Uncomment the following lines if you want to delete the downloaded file
# import os
# os.remove(download_path)

# Use the shape predictor in your code
